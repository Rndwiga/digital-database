...
@section('content')
    ...
    <!-- banner-top -->
        {{--Activate me when we grow bigger --}}
            @include(config('biashara.views.pages.home.list-categories'))
    <!-- //banner-top -->
        <!-- banner- hot deals -->
           {{--Activate me when we grow bigger --}}
    ...
    <!-- special-deals -->
        {{--Activate me when we grow bigger --}}
            @include(config('biashara.views.pages.home.special-deals'))
    <!-- special-deals -->
    <!-- new-products -->
    ...
    <!-- top-brands -->
        {{--Activate me when we grow bigger --}}
            {{--@include(config('biashara.views.pages.home.top-brand'))--}}
    <!-- top-brands -->
    <!-- banner-bottom -->
@endsection
