                    ...
                    <div class="w3ls_mobiles_grid_left_grid">
                        ...
                        <div class="w3ls_mobiles_grid_left_grid_sub">
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body panel_text">
                                            <ul>
                                                <li><a href="{{route('biashara.products.list')}}">Mobiles</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Laptop</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Tv</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Wearables</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Refrigerator</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body panel_text">
                                            <ul>
                                                <li><a href="{{route('biashara.products.list')}}">Grinder</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Heater</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Kid's Toys</a></li>
                                                <li><a href="{{route('biashara.products.list')}}">Filters</a></li>
                            ...
                            <ul class="panel_bottom">
                                <li><a href="{{route('biashara.products.list')}}">Summer Store</a></li>
                                <li><a href="{{route('biashara.products.list')}}">Featured Brands</a></li>
                                <li><a href="{{route('biashara.products.list')}}">Today's Deals</a></li>
                                <li><a href="{{route('biashara.products.list')}}">Latest Watches</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="w3ls_mobiles_grid_left_grid">
                ...
                <div class="col-md-8 w3ls_mobiles_grid_right">
                    <div class="col-md-6 w3ls_mobiles_grid_right_left">
                        <div class="w3ls_mobiles_grid_right_grid1">
                            <img src="{{asset('vendor/tyondo/biashara/images/46.jpg')}}" alt=" " class="img-responsive" />
                    ...
                    <div class="col-md-6 w3ls_mobiles_grid_right_left">
                        <div class="w3ls_mobiles_grid_right_grid1">
                            <img src="{{asset('vendor/tyondo/biashara/images/47.jpg')}}" alt=" " class="img-responsive" />
                    ...
                    <div class="w3ls_mobiles_grid_right_grid3">
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                <div class="hs-wrapper hs-wrapper2">
                                    <img src="{{asset('vendor/tyondo/biashara/images/31.jpg')}}" alt=" " class="img-responsive" />
                        ...
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                <div class="hs-wrapper hs-wrapper2">
                                    <img src="{{asset('vendor/tyondo/biashara/images/p1.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/p2.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/p3.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/p4.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/p1.jpg')}}" alt=" " class="img-responsive" />
                                    <div class="w3_hs_bottom w3_hs_bottom_sub1">
                                        <ul>
                                            <li>
                        ...
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                <div class="hs-wrapper hs-wrapper2">
                                    <img src="{{asset('vendor/tyondo/biashara/images/30.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/28.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/26.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/27.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/29.jpg')}}" alt=" " class="img-responsive" />
                                    <div class="w3_hs_bottom w3_hs_bottom_sub1">
                                        <ul>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#myModal9"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                    ...
                    <div class="w3ls_mobiles_grid_right_grid3">
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                <div class="hs-wrapper hs-wrapper2">
                                    ...
                                    <img src="{{asset('vendor/tyondo/biashara/images/p3.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/p2.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/p5.jpg')}}" alt=" " class="img-responsive" />
                                    <div class="w3_hs_bottom w3_hs_bottom_sub1">
                                        <ul>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#myModal4"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                        ...
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                <div class="hs-wrapper hs-wrapper2">
                                    <img src="{{asset('vendor/tyondo/biashara/images/p6.jpg')}}" alt=" " class="img-responsive" />
                    ...
                    <div class="w3ls_mobiles_grid_right_grid3">
                        ...
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                <div class="hs-wrapper hs-wrapper2">
                                    <img src="{{asset('vendor/tyondo/biashara/images/35.jpg')}}" alt=" " class="img-responsive" />
                                    <img src="images/30.jpg" alt=" " class="img-responsive" />
                                    <img src="images/27.jpg" alt=" " class="img-responsive" />
                                    <img src="images/28.jpg" alt=" " class="img-responsive" />
                                    <img src="{{asset('vendor/tyondo/biashara/images/29.jpg')}}" alt=" " class="img-responsive" />
                        ...
                        <div class="col-md-7 modal_body_right">
                            ...
                            <div class="rating">
                                <div class="rating-left">
                                    <img src="{{asset('vendor/tyondo/biashara/images/star-.png')}}" alt=" " class="img-responsive" />
                                </div>
                                <div class="rating-left">
