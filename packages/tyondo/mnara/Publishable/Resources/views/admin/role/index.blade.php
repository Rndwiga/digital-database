...
@section('content')
    <div class="right_col" role="main">
        ...
        <!-- search bar -->
        @include( config('mnara.views.layouts.search'), [ 'search_route' => config('mnara.route.as') .'role.index', 'items' => $roles, 'acl' => 'role' ] )
            ...
            <table class="table table-hover">
                ...
                @forelse($roles as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route( config('mnara.route.as') .'role.show', $item->id) }}">{{ $item->name }}</a>
