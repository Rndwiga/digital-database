...
@section('content')
    <div class="right_col" role="main">
        ...
        {!! Form::model($resource, ['method' => 'PATCH', 'route' => [ 'mnara.user.update', $resource->id ], 'class' => 'form-horizontal']) !!}
            ...
            @else
                <div class="form-group">
                    <div class="col-sm-6 col-sm-offset-3">
                        <a href="{{ route('mnara.user.edit', $resource->id) }}" class="pull-right" title="Edit this User">
                            <i class="fa fa-pencil fa-fw"></i>
                            <span class="hidden-xs hidden-sm">Edit</span>
                            </button></a>

                        <a href="{{ route('mnara.user.role.edit', $resource->id) }}" title="Roles for this user">
